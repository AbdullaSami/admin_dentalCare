        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{route('main-page.update', $offer->id)}}" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto p-6 bg-white shadow-md rounded-lg space-y-4">
                        @csrf
                        @method('PUT')
                        <!-- Text Input -->
                        <div>
                        ...
                        <!-- Image Upload -->
                        <div>
                            <img class="h-32 " src="{{$offer->img}}" alt="{{$offer->img}}">
